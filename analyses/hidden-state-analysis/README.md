## About
This directory contains code for various analyses dependent on the pre-MLP hidden states. All code here requires that `/analyses/export-data/export-activations.ipynb` has been run first.
...
- `router-analysis.ipynb` contains code to analyze the MoE router and understand how the hidden state is correlated to routing weights.
    - `router-analysis.md` contains graphing code to run afterwards.
